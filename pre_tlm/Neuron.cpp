...
Neuron::Neuron(sc_module_name name, sc_event *ready, double* input, int input_size, deque<double> weights, double bias, double *result):
ready(ready),input(input), input_size(input_size), weights(weights), bias(bias), result(result)
{
