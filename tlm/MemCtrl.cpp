                                       ...
                                       buffer(NULL)
{
   ...
   cout<<name<<" constructed"<<endl;
	...
	//num_weights_l1 + num_biases_l1 + num_weights_l2 + num_biases_l2
   mem.reserve(784*30+30+30*10+10);
   ...
   for(int i=0; i<2; i++)
      {
         ...
         if(weights_file.is_open())
            ...
            cout<<RED<<"ERROR OPENING WEIGHTS_FILE number: "<<i<<RST<<endl;
         weights_file.close();
