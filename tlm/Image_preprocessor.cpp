...
void Image_preprocessor::b_transport(pl_t& pl, sc_time& offset)
{
   ...
   if(cmd==TLM_WRITE_COMMAND && adr==0x82000000)
   {
      start=SC_LOGIC_1; 
...
vector<din_t> Image_preprocessor:: Image_preprocessing(vector <din_t> image)
{
...
void Image_preprocessor::calc_center(vector<din_t> image, p_t& x_CenterOfMass, p_t& y_CenterOfMass)
{
